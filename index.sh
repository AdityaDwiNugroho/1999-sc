...
_() {
  ...
  echo "Greetings from ${YEAR}. This moment was crafted by [@${USERNAME}](https://github.com/${USERNAME})" > README.md
  echo "${YEAR} - Generated by https://github.com/${USERNAME}/${YEAR}-sc" >> README.md
